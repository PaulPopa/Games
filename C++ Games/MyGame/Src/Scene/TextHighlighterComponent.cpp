...
void TextHighlighterComponent::OnStart()
{
	...
	m_highlightedColorMask.x = (float)Min((int)m_highlightedColorMask.x, color.r - (int)m_highlightedColorMask.x);
	m_highlightedColorMask.y = (float)Min((int)m_highlightedColorMask.y, color.g - (int)m_highlightedColorMask.y);
	m_highlightedColorMask.z = (float)Min((int)m_highlightedColorMask.z, color.b - (int)m_highlightedColorMask.z);
}
